...
/** Market buy to open a long position with native preset TP and SL attached directly to entry payload. */
...
/** Limit buy to open a long position with native preset TP and SL attached directly to entry payload. */
